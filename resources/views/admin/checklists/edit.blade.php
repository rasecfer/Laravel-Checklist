        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                        ...
                        <div class="card-body">
                            <div class="row justify-content-center">
                                <div class="col-sm-12">
                                    ...
                                    >
                                    <div
                                        class="invalid-feedback">{{ $errors->has('name') ? $errors->first('name') : '' }}</div>
                                </div>
                            </div>
                        </div>
                ...
                <form action="{{ route('admin.checklist_groups.checklists.destroy', [$checklistGroup, $checklist]) }}"
                    ...
                    @csrf
                    @method('DELETE')
                    <button class="btn btn-danger mb-2 mt-2" type="submit"
                            onclick="return confirm('{{ __('Are you sure?') }}')">{{ __('Delete Checklist') }}</button>
                </form>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        >
                                        <div
                                            class="invalid-feedback">{{ $errors->storetask->has('name') ? $errors->storetask->first('name') : '' }}</div>
                                    </div>
                                    <div class="form-group mt-2">
                                        ...
                                        <div
                                            class="invalid-feedback">{{ $errors->storetask->has('description') ? $errors->storetask->first('description') : '' }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
